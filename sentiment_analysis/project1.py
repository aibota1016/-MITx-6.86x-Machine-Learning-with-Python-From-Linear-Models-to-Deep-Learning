...
def hinge_loss_full(feature_matrix, labels, theta, theta_0):
    ...
    # Your code here
    loss = 0
    length = feature_matrix.T[0].size
...
def perceptron_single_step_update(
    ...
    # Your code here
    epoch = 1e-7
    if label * (np.dot(current_theta, feature_vector) + current_theta_0) <= epoch:
...
def classifier_accuracy(
    ...
    preds_val = classify(val_feature_matrix, theta, theta_0)
    train_acc = accuracy(preds_train, train_labels)
    val_acc = accuracy(preds_val, val_labels)
